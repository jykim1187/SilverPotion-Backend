...
- **주요 기능 요약** :  
  **1️⃣ 실버 헬스케어**
    - 갤럭시 워치 등 웨어러블 기기 연동을 통한 실시간 데이터 수집(걸음수,심박수,체온,혈압,소모칼로리 등)
    - 수집된 데이터를 통해 일/주/월 단위로 건강 리포트 제공
    - AI가 개인 건강 데이터를 분석해 개인 맞춤형 건강리포트 제공
    - 보호자가 노인의 건강 데이터를 조회할 수 있음
    - 자신의 건강과 정서성향에 맞는 소모임추천천
...
| 이름 | 역할 | GitHub |
|:------|:------------------------|:-----------------------------|
| 경수혁 | 팀장 | [github.com/issac-cosmos](https://github.com/issac-cosmos) |
| 이재석 | 팀원 | [github.com/leejaeseok-98](https://github.com/leejaeseok-98) |
| 최영일 | 팀원 | [github.com/01youngil](https://https://github.com/01youngil) |
| 김진영 | 팀원 | [github.com/jykim1187](https://github.com/jykim1187) |
